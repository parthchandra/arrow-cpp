...
if ("$ENV{DISABLE_NATIVE_TOOLCHAIN}" STREQUAL "")
  ...
  set(ENV{GPERFTOOLS_PREFIX}
    "$ENV{NATIVE_TOOLCHAIN}/gperftools-$ENV{GPERFTOOLS_VERSION}")
  set(ENV{LIBUNWIND_PREFIX}
    "$ENV{NATIVE_TOOLCHAIN}/libunwind-$ENV{LIBUNWIND_VERSION}")
