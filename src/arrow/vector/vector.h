...
#include "decimal-utils.h"


#if defined _WIN32 || defined __CYGWIN__
  #ifdef ARROW_CLIENT_EXPORTS
      #define DECLSPEC_ARROW_CLIENT __declspec(dllexport)
  #else
    #ifdef USE_STATIC_LIBARROW
      #define DECLSPEC_ARROW_CLIENT
    #else
      #define DECLSPEC_ARROW_CLIENT  __declspec(dllimport)
    #endif
  #endif
#else
  #if __GNUC__ >= 4
    #define DECLSPEC_ARROW_CLIENT __attribute__ ((visibility ("default")))
  #else
    #define DECLSPEC_ARROW_CLIENT
  #endif
#endif
...
class DECLSPEC_ARROW_CLIENT ValueVectorBase{
    public:
...
class DECLSPEC_ARROW_CLIENT ValueVectorUnimplemented:public ValueVectorBase{
    public:
...
class DECLSPEC_ARROW_CLIENT ValueVectorNull:public ValueVectorBase{
    public:
...
class DECLSPEC_ARROW_CLIENT ValueVectorFixedWidth:public ValueVectorBase{
    public:
...
class DECLSPEC_ARROW_CLIENT ValueVectorBit:public ValueVectorFixedWidth{
    public:
...
struct DECLSPEC_ARROW_CLIENT DateTimeBase{
...
struct DECLSPEC_ARROW_CLIENT DateHolder: public virtual DateTimeBase{
    DateHolder(){};
...
struct DECLSPEC_ARROW_CLIENT TimeHolder: public virtual DateTimeBase{
    TimeHolder(){};
...
struct DECLSPEC_ARROW_CLIENT DateTimeHolder: public DateHolder, public TimeHolder{
    DateTimeHolder(){};
...
struct DECLSPEC_ARROW_CLIENT DateTimeTZHolder: public DateTimeHolder{
...
class DECLSPEC_ARROW_CLIENT VarWidthHolder{
    public:
        ByteBuf_t data;
        size_t size;
};

class DECLSPEC_ARROW_CLIENT ValueVectorVarWidth:public ValueVectorBase{
    public:
...
class DECLSPEC_ARROW_CLIENT ValueVectorVarChar:public ValueVectorVarWidth{
    public:
...
class DECLSPEC_ARROW_CLIENT ValueVectorVarBinary:public ValueVectorVarWidth{
    public:
